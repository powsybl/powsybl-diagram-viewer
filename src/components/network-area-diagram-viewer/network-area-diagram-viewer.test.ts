...
describe('Test DiagramUtils', () => {
    ...
    test('getFormattedPolyline', () => {
        ...
        expect(
            DiagramUtils.getFormattedPolyline(
                new Point(144, 34.836),
                new Point(192.83, 55.1475),
                new Point(213.892, 74)
            )
    ...
    test('getDraggableFrom', () => {
        let draggagleElement = DiagramUtils.getDraggableFrom(TestUtils.getSvgNode());
        expect(draggagleElement).not.toBeUndefined();
        draggagleElement = DiagramUtils.getDraggableFrom(TestUtils.getSvgTextNode());
        expect(draggagleElement).not.toBeUndefined();
        draggagleElement = DiagramUtils.getDraggableFrom(TestUtils.getSvgLoopEdge());
        expect(draggagleElement).toBeUndefined();
    });

    test('getSelectableFrom', () => {
        let selectableElement = DiagramUtils.getSelectableFrom(TestUtils.getSvgNode());
        expect(selectableElement).not.toBeUndefined();
        selectableElement = DiagramUtils.getSelectableFrom(TestUtils.getSvgTextNode());
        expect(selectableElement).toBeUndefined();
        selectableElement = DiagramUtils.getSelectableFrom(TestUtils.getSvgLoopEdge());
        expect(selectableElement).toBeUndefined();
    });
    ...
    test('getPolylinePoints', () => {
        const points = DiagramUtils.getPolylinePoints(TestUtils.getSvgPolyline());
    ...
    test('getPolylineAngle', () => {
        const angle = DiagramUtils.radToDeg(DiagramUtils.getPolylineAngle(TestUtils.getSvgPolyline()) ?? 0);
        expect(angle).toBeCloseTo(-120, 0);
    });

    test('getPathAngle', () => {
        const angle = DiagramUtils.radToDeg(DiagramUtils.getPathAngle(TestUtils.getSvgPath()) ?? 0);
    ...
    test('isTextNode', () => {
        const isTextNode = DiagramUtils.isTextNode(TestUtils.getSvgTextNode());
    ...
    test('getTextNodeAngleFromCentre', () => {
        ...
        const textNodeAngle = DiagramUtils.getTextNodeAngleFromCentre(TestUtils.getSvgTextNode(), new Point(240, -310));
        expect(textNodeAngle.x).toBe(240);
        expect(textNodeAngle.y).toBe(-310);
    });

    test('getTextNodeTranslatedPosition', () => {
        const textNodePosition = DiagramUtils.getTextNodeTranslatedPosition(
            TestUtils.getSvgTextNode(),
            new Point(10, 10)
        );
    ...
    test('getTextNodePosition', () => {
        const textNodePosition = DiagramUtils.getTextNodePosition(TestUtils.getSvgTextNode());
    ...
    test('getHoverableFrom', () => {
        let hoverableElement = DiagramUtils.getHoverableFrom(TestUtils.getSvgNode());
        expect(hoverableElement).toBeUndefined();
        hoverableElement = DiagramUtils.getHoverableFrom(TestUtils.getSvgTextNode());
        expect(hoverableElement).toBeUndefined();
        hoverableElement = DiagramUtils.getHoverableFrom(TestUtils.getSvgLoopEdge());
