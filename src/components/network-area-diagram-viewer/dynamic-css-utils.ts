...
export type CSS_DECLARATION_TEST = Record<string, (value: number) => string>;
export type CSS_RULE_TEST = {
    cssSelector: string;
    cssDeclaration: CSS_DECLARATION_TEST;
...
export const DEFAULT_DYNAMIC_CSS_RULES_TEST: CSS_RULE_TEST[] = [
    {
        cssSelector: '.nad-edge-infos', // data on edges (arrows and values)
